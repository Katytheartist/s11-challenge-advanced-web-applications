...
export default function ArticleForm(props) {
  ...
  const {postArticle, updateArticle, setCurrentArticleId, currentArticleId, articles, getArticles}= props
  useEffect(() => {
    // ✨ implement
  ...
  const onSubmit = evt => {
    ...
    if (articles.find(article => article.article_id === currentArticleId)){
